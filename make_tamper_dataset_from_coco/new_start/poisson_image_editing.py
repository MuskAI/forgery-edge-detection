...
def poisson_fusion(src,target,mask,offset=(0,0)):
    """

    :param src: 前景图
    :param target: 背景图
    :param mask:
    :param offset: 默认前景图和背景图尺寸一致，如不一致，则使用offse
    :return: fusion image
    """
    result = poisson_edit(src, target, mask, offset)
    return result
