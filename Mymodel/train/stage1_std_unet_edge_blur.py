...
from datasets.dataloader_blur import TamperDataset
...
"          参数               "
""""""""""""""""""""""""""""""
name = '0321_stage1后缀为0306的模型，训练双边缘第一阶段,无八张图约束，边缘模糊数据'
...
def main():
    ...
    # 2 define 3 types
    trainData = TamperDataset(stage_type='stage2', using_data=using_data, train_val_test_mode='train',device='413blur')
    valData = TamperDataset(stage_type='stage2', using_data=using_data, train_val_test_mode='val',device='413blur')
    testData = TamperDataset(stage_type='stage2', using_data=using_data_test, train_val_test_mode='test',device='413blur')
